...
export function FEMME({navigation}){
    ...
    return(
     ...
     <View style={{marginTop: 4,paddingHorizontal: 5, flexDirection: 'row'}}>
      ...
      <ScrollView
                                    ...
                                    width: '40%',
                                        height: '40%',
                                           ...
                                           resizeMode: 'center',
                                                 ...
                                                 />
                                                 <Text style={style.textsize}>FEMMES</Text>
          ...
          source={require('../screens/images/back.jpg')}
          style={{
              height:130,
              width:300,
              marginRight:20,
          ...
          <View style={{flexDirection: 'row',paddingLeft:10,marginTop:20}}>
                     ...
                     horizontal
                     showsHorizontalScrollIndicator={false}
                     style={{marginTop:20,paddingHorizontal:2}}
                    >
                          <View
                         style= {style.toucheview2}>
                         
                         <Image
                            // source={require('./assets/femmeimage/col1.jpg')}
                            source={require('../screens/images/col1.jpg')}

                                    style={style.image}
                                         />
                                         <Text onPress={() => {navigation.navigate('AC')}} style={style.textsize}>Colliers </Text>             
                         </View>
                         <TouchableOpacity
                         style= {style.toucheview2}>
                         ...
                         <Image
                            ...
                            source={require('../screens/images/bag1.webp')}
                                    style={style.image}
                                         />
                                         <Text style={style.textsize}>Bagues</Text> 
                                                  <Text style={style.textsize}>et Bracelets</Text> 
                         ...
                         <Image
                            ...
                            source={require('../screens/images/bouc.jpg')}
                                    style={style.image}
                                         />
                                                  <Text style={style.textsize}>Boucles d'oreilles</Text>
                    ...
                    >
                       <TouchableOpacity
                         ...
                         <Image
                            source={require('../screens/images/saccuir.webp')}
                           
                                    style={style.image}
                                         />
                                                  <Text style={style.textsize}>Sacs</Text>
                         ...
                         <Image
                          source={require('../screens/images/sacp1.webp')}
                                    style={style.image1}
                                         />
                                                  <Text style={style.textsize}>Sacs</Text>
                                                  <Text style={style.textsize}>en paille</Text>             
                         ...
                         <Image
                            source={require('../screens/images/sacd.webp')}
                                    style={style.image}
                                         />
                                                  <Text style={style.textsize}>Sacs</Text>
                                                  <Text style={style.textsize}>a dos</Text>             
                         </TouchableOpacity>     
                    </ScrollView>
                    ...
                    >
                         ...
                         <Image
                          source={require('../screens/images/sandalec1.jpg')}
                                    style={style.image}
                                         />
                         ...
                         <Image
                            source={require('../screens/images/mules.jpg')}
                                    style={style.image}
                                         /><Text style={style.textsize}>Mules</Text>
                                                  {/* <Text style={style.textsize}>fille</Text>              */}
                         </TouchableOpacity>
                          <TouchableOpacity
                         style= {style.toucheview2}>
                          <Image
                           source={require('../screens/images/babou.jpg')}
                                    style={style.image}
                                         />
                                                  <Text style={style.textsize}>Babouches</Text>
